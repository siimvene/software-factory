...
| A batch of stories through the loop (epic, parallel stations, ordered merges, two-step deploy) | measured | kvart cycle 4 | pickup → backend PR 2 h 08 min, → live 3 h 57 min; the strict ratchet and the related-set rule were the two friction sources; see case study |
