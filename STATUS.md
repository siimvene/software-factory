...
Which parts of the design sit in which evidence class, as of 2026-09-09 evening. See
...
| Static analysis as a receipt-checked pre-push gate (local scan scoped by changed sources, receipt bound to tree + project set, same hook as the browser receipt) | designed | kvart | KVART-16 (#43) open 2026-09-09 in another session; its first CI run was red on the strict duplication baseline, the deadlock ADR 0004 now decides |
